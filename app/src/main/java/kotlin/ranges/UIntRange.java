...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt>, OpenEndRange<UInt> {
    ...
    public static /* synthetic */ void m12631getEndExclusivepVg5ArA$annotations() {
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m12632containsWZ4Q5Ns(((UInt) comparable).getData());
    }

    @Override // kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ Comparable getEndExclusive() {
        return UInt.m11456boximpl(m12633getEndExclusivepVg5ArA());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ Comparable getEndInclusive() {
        return UInt.m11456boximpl(m12634getEndInclusivepVg5ArA());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ Comparable getStart() {
        return UInt.m11456boximpl(m12635getStartpVg5ArA());
    }
    ...
    public String toString() {
        return ((Object) UInt.m11508toStringimpl(getFirst())) + ".." + ((Object) UInt.m11508toStringimpl(getLast()));
    }
