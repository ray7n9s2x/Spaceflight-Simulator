...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m12575getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM11541constructorimpl = ((int) ULong.m11541constructorimpl(j ^ ULong.m11541constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM11541constructorimpl2 = (iM11541constructorimpl + ((int) ULong.m11541constructorimpl(j2 ^ ULong.m11541constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM11541constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m11587toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m11587toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m12638fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
