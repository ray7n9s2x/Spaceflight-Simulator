...
public final class UByteArray implements Collection<UByte>, KMappedMarker {
    ...
    public static final /* synthetic */ UByteArray m11436boximpl(byte[] bArr) {
        return new UByteArray(bArr);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static byte[] m11438constructorimpl(byte[] storage) {
        Intrinsics.checkNotNullParameter(storage, "storage");
        return storage;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m11441equalsimpl(byte[] bArr, Object obj) {
        return (obj instanceof UByteArray) && Intrinsics.areEqual(bArr, ((UByteArray) obj).getStorage());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m11442equalsimpl0(byte[] bArr, byte[] bArr2) {
    ...
    public static int m11445hashCodeimpl(byte[] bArr) {
        return Arrays.hashCode(bArr);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m11449toStringimpl(byte[] bArr) {
    ...
    public boolean m11450add7apg3OU(byte b) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean equals(Object obj) {
        return m11441equalsimpl(this.storage, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return m11445hashCodeimpl(this.storage);
    }
    ...
    public String toString() {
        return m11449toStringimpl(this.storage);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UByte) {
            return m11451contains7apg3OU(((UByte) obj).getData());
        }
        return false;
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static byte[] m11437constructorimpl(int i) {
        return m11438constructorimpl(new byte[i]);
    }

    /* JADX INFO: renamed from: get-w2LRezQ, reason: not valid java name */
    public static final byte m11443getw2LRezQ(byte[] bArr, int i) {
        return UByte.m11380constructorimpl(bArr[i]);
    }

    /* JADX INFO: renamed from: set-VurrAj0, reason: not valid java name */
    public static final void m11448setVurrAj0(byte[] bArr, int i, byte b) {
        bArr[i] = b;
    }

    /* JADX INFO: renamed from: getSize-impl, reason: not valid java name */
    public static int m11444getSizeimpl(byte[] bArr) {
        return bArr.length;
    }
    ...
    public int size() {
        return m11444getSizeimpl(this.storage);
    }

    /* JADX INFO: renamed from: iterator-impl, reason: not valid java name */
    public static java.util.Iterator<UByte> m11447iteratorimpl(byte[] bArr) {
        return new Iterator(bArr);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public java.util.Iterator<UByte> iterator() {
        return m11447iteratorimpl(this.storage);
    }
    ...
    private static final class Iterator implements java.util.Iterator<UByte>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UByte next() {
            return UByte.m11374boximpl(m11453nextw2LRezQ());
        }
    ...
    public boolean m11451contains7apg3OU(byte b) {
        return m11439contains7apg3OU(this.storage, b);
    }

    /* JADX INFO: renamed from: contains-7apg3OU, reason: not valid java name */
    public static boolean m11439contains7apg3OU(byte[] bArr, byte b) {
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        return m11440containsAllimpl(this.storage, elements);
    }

    /* JADX INFO: renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m11440containsAllimpl(byte[] bArr, Collection<UByte> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m11446isEmptyimpl(byte[] bArr) {
        return bArr.length == 0;
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return m11446isEmptyimpl(this.storage);
    }
}
