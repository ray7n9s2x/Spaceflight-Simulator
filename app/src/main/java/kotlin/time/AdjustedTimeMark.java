...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo12721minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m12867minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo12720elapsedNowUwyO8pc() {
        return Duration.m12765minusLRDsOJo(this.mark.mo12720elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo12723plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m12766plusLRDsOJo(this.adjustment, duration), null);
    }
}
