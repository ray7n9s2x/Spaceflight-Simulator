...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m12870boximpl(m12864markNowz9LOYto());
    }
    ...
    public long m12864markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m12873constructorimpl(read());
    }

    /* JADX INFO: renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m12863elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m12862differenceBetweenfRLX17w(long one, long another) {
    ...
    public final long m12861adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m12873constructorimpl(LongSaturatedMathKt.m12859saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
