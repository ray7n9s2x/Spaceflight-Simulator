...
public final class UnsignedKt {
    ...
    public static final int m11719uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m11462constructorimpl((int) ((((long) i) & 4294967295L) % (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: uintDivide-J1ME1BU, reason: not valid java name */
    public static final int m11718uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m11462constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m11720ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? ULong.m11541constructorimpl(0L) : ULong.m11541constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m11541constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m11541constructorimpl(j3 + ((long) (Long.compare(ULong.m11541constructorimpl(j - (j3 * j2)) ^ Long.MIN_VALUE, ULong.m11541constructorimpl(j2) ^ Long.MIN_VALUE) < 0 ? 0 : 1)));
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m11721ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? j : ULong.m11541constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m11541constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compare(ULong.m11541constructorimpl(j3) ^ Long.MIN_VALUE, ULong.m11541constructorimpl(j2) ^ Long.MIN_VALUE) < 0) {
            j2 = 0;
        }
        return ULong.m11541constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= 2.147483647E9d) {
            return UInt.m11462constructorimpl((int) d);
        }
        return UInt.m11462constructorimpl(UInt.m11462constructorimpl((int) (d - ((double) Integer.MAX_VALUE))) + UInt.m11462constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m11541constructorimpl((long) d);
        }
        return ULong.m11541constructorimpl(ULong.m11541constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
