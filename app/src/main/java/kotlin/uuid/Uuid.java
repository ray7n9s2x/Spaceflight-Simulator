...
public final class Uuid implements Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m11535boximpl(ULong.m11541constructorimpl(getMostSignificantBits())), ULong.m11535boximpl(ULong.m11541constructorimpl(getLeastSignificantBits())));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m12893fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
    ...
    public static final int LEXICAL_ORDER$lambda$2(Uuid uuid, Uuid uuid2) {
        ...
        return j != uuid2.mostSignificantBits ? Long.compare(ULong.m11541constructorimpl(j) ^ Long.MIN_VALUE, ULong.m11541constructorimpl(uuid2.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m11541constructorimpl(uuid.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m11541constructorimpl(uuid2.leastSignificantBits) ^ Long.MIN_VALUE);
    }
}
