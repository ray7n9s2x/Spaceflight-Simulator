...
public final class Result<T> implements Serializable {
    ...
    public static final /* synthetic */ Result m11361boximpl(Object obj) {
        return new Result(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m11362constructorimpl(Object obj) {
        return obj;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m11363equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).getValue());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m11364equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m11367hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public boolean equals(Object obj) {
        return m11363equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m11367hashCodeimpl(this.value);
    }
    ...
    public static final boolean m11369isSuccessimpl(Object obj) {
        return !(obj instanceof Failure);
    }

    /* JADX INFO: renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m11368isFailureimpl(Object obj) {
        return obj instanceof Failure;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getOrNull-impl, reason: not valid java name */
    private static final T m11366getOrNullimpl(Object obj) {
        if (m11368isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static final Throwable m11365exceptionOrNullimpl(Object obj) {
    ...
    public String toString() {
        return m11370toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m11370toStringimpl(Object obj) {
        if (obj instanceof Failure) {
            return obj.toString();
        }
        return "Success(" + obj + ')';
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T value) {
            return Result.m11362constructorimpl(value);
        }

        private final <T> Object failure(Throwable exception) {
            Intrinsics.checkNotNullParameter(exception, "exception");
            return Result.m11362constructorimpl(ResultKt.createFailure(exception));
        }
    }
