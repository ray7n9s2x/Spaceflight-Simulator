...
public final class UStringsKt {
    ...
    public static final String m12717toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m12719toStringolVBNx4(short s, int i) {
    ...
    public static final String m12718toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m12716toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m11462constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m11374boximpl(UByte.m11380constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m11462constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m11642boximpl(UShort.m11648constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM11462constructorimpl = UInt.m11462constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM11462constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM11462constructorimpl2 = UInt.m11462constructorimpl(i3 * iM11462constructorimpl);
            int iM11462constructorimpl3 = UInt.m11462constructorimpl(UInt.m11462constructorimpl(iDigitOf) + iM11462constructorimpl2);
            if (Integer.compare(iM11462constructorimpl3 ^ Integer.MIN_VALUE, iM11462constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM11462constructorimpl3;
        }
        return UInt.m11456boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM11541constructorimpl = ULong.m11541constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM11541constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM11541constructorimpl2 = ULong.m11541constructorimpl(j * jM11541constructorimpl);
            long jM11541constructorimpl3 = ULong.m11541constructorimpl(ULong.m11541constructorimpl(((long) UInt.m11462constructorimpl(iDigitOf)) & 4294967295L) + jM11541constructorimpl2);
            if (Long.compare(jM11541constructorimpl3 ^ Long.MIN_VALUE, jM11541constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM11541constructorimpl3;
        }
        return ULong.m11535boximpl(j);
    }
}
