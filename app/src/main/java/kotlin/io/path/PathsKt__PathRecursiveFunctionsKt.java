...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
        ...
        if ((i & 2) != 0) {
            function3 = new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.1
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj2, Object obj3, Object obj4) {
                    return invoke(C$$ExternalSyntheticApiModelOutline0.m6642m(obj2), C$$ExternalSyntheticApiModelOutline0.m6642m(obj3), (Exception) obj4);
                }
        ...
        if (z2) {
            return PathsKt.copyToRecursively(path, target, onError, z, new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.2
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path2, Path path3) {
                    return invoke2(copyActionContext, C$$ExternalSyntheticApiModelOutline0.m6642m((Object) path2), C$$ExternalSyntheticApiModelOutline0.m6642m((Object) path3));
                }
        ...
        if ((i & 8) != 0) {
            function32 = new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.4
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path3, Path path4) {
                    return invoke2(copyActionContext, C$$ExternalSyntheticApiModelOutline0.m6642m((Object) path3), C$$ExternalSyntheticApiModelOutline0.m6642m((Object) path4));
                }
    ...
    public static final Path copyToRecursively(final Path path, final Path target, final Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> onError, boolean z, final Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> copyAction) throws FileSystemException {
        ...
        if (!Files.exists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            PathTreeWalk$$ExternalSyntheticApiModelOutline0.m12611m$1();
            throw PathTreeWalk$$ExternalSyntheticApiModelOutline0.m12583m(path.toString(), target.toString(), "The source file doesn't exist.");
        }
        ...
        if (Files.exists(path, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && (z || !Files.isSymbolicLink(path))) {
            ...
            if (!z2 || !Files.isSameFile(path, target)) {
                ...
                if (zStartsWith) {
                    C$$ExternalSyntheticApiModelOutline0.m$3();
        ...
        PathsKt.visitFileTree$default(path, 0, z, new Function1<FileVisitorBuilder, Unit>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5
            ...
            public final void invoke2(FileVisitorBuilder visitFileTree) {
                ...
                visitFileTree.onPreVisitDirectory(new Function2<Path, BasicFileAttributes, FileVisitResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5.1
                    ...
                    public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path5, BasicFileAttributes basicFileAttributes) {
                        return invoke2(C$$ExternalSyntheticApiModelOutline0.m6642m((Object) path5), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m12590m((Object) basicFileAttributes));
                    }
                ...
                visitFileTree.onPostVisitDirectory(new Function2<Path, IOException, FileVisitResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5.4
                    ...
                    public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path8, IOException iOException) {
                        return invoke2(C$$ExternalSyntheticApiModelOutline0.m6642m((Object) path8), iOException);
                    }
            ...
            /* synthetic */ class AnonymousClass2 extends FunctionReferenceImpl implements Function2<Path, BasicFileAttributes, FileVisitResult> {
                ...
                public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path, BasicFileAttributes basicFileAttributes) {
                    return invoke2(C$$ExternalSyntheticApiModelOutline0.m6642m((Object) path), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m12590m((Object) basicFileAttributes));
                }
            ...
            /* synthetic */ class AnonymousClass3 extends FunctionReferenceImpl implements Function2<Path, Exception, FileVisitResult> {
                ...
                public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path, Exception exc) {
                    return invoke2(C$$ExternalSyntheticApiModelOutline0.m6642m((Object) path), exc);
                }
    ...
    public static final FileVisitResult copyToRecursively$copy$PathsKt__PathRecursiveFunctionsKt(ArrayList<Path> arrayList, Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> function3, Path path, Path path2, Path path3, Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> function32, Path path4, BasicFileAttributes basicFileAttributes) {
        try {
            if (!arrayList.isEmpty()) {
                ...
                checkNotSameAs$PathsKt__PathRecursiveFunctionsKt(path4, C$$ExternalSyntheticApiModelOutline0.m6642m(CollectionsKt.last((List) arrayList)));
            }
    ...
    public static final void deleteRecursively(Path path) throws IOException {
        ...
        FileSystemException fileSystemExceptionM = C$$ExternalSyntheticApiModelOutline0.m("Failed to delete one or more files. See suppressed exceptions for details.");
        ...
        if (parent != null) {
            ...
            if (directoryStreamNewDirectoryStream != null) {
                ...
                try {
                    ...
                    if (PathTreeWalk$$ExternalSyntheticApiModelOutline0.m12601m((Object) directoryStreamM)) {
                        exceptionsCollector.setPath(parent);
                        SecureDirectoryStream secureDirectoryStreamM12586m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m12586m((Object) directoryStreamM);
                        Path fileName = path.getFileName();
                        Intrinsics.checkNotNullExpressionValue(fileName, "getFileName(...)");
                        handleEntry$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStreamM12586m, fileName, null, exceptionsCollector);
                    } else {
                        z = true;
                    }
    ...
    */
    private static final void handleEntry$PathsKt__PathRecursiveFunctionsKt(java.nio.file.SecureDirectoryStream<java.nio.file.Path> r2, java.nio.file.Path r3, java.nio.file.Path r4, kotlin.io.path.ExceptionsCollector r5) {
        ...
        L12:
            ...
            java.nio.file.LinkOption r0 = com.unity3d.player.C$$ExternalSyntheticApiModelOutline0.m6641m()     // Catch: java.lang.Exception -> L3b
            r1 = 0
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            ...
            try {
                SecureDirectoryStream secureDirectoryStreamM12586m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m12586m((Object) secureDirectoryStream2);
                Iterator it = secureDirectoryStreamM12586m.iterator();
                while (it.hasNext()) {
                    Path fileName = C$$ExternalSyntheticApiModelOutline0.m6642m(it.next()).getFileName();
                    Intrinsics.checkNotNullExpressionValue(fileName, "getFileName(...)");
                    handleEntry$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStreamM12586m, fileName, exceptionsCollector.getPath(), exceptionsCollector);
                }
                Unit unit = Unit.INSTANCE;
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        Boolean boolValueOf;
        try {
            boolValueOf = Boolean.valueOf(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m12589m((Object) secureDirectoryStream.getFileAttributeView(path, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))).readAttributes().isDirectory());
        } catch (NoSuchFileException unused) {
            boolValueOf = null;
        }
        if (boolValueOf != null) {
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            ...
            try {
                ...
                while (it.hasNext()) {
                    Path pathM6642m = C$$ExternalSyntheticApiModelOutline0.m6642m(it.next());
                    Intrinsics.checkNotNull(pathM6642m);
                    insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(pathM6642m, path, exceptionsCollector);
                }
                Unit unit = Unit.INSTANCE;
                CloseableKt.closeFinally(directoryStream, null);
            } finally {
    ...
    private static final void checkNotSameAs$PathsKt__PathRecursiveFunctionsKt(Path path, Path path2) throws FileSystemLoopException {
        ...
        PathTreeWalk$$ExternalSyntheticApiModelOutline0.m12599m();
