...
/* JADX INFO: renamed from: apkvision.ۤ۟ۢۡ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes2.dex */
public class C0014 {

    /* JADX INFO: renamed from: ۢۡ۟ۥ, reason: not valid java name and contains not printable characters */
    public static int f13 = -164;
    ...
    public static int m475() {
        return (-726) ^ C0011.f10;
    }

    /* JADX INFO: renamed from: ۟ۢۥ۠۟, reason: not valid java name and contains not printable characters */
    public static String m472(short[] sArr, int i, int i2, int i3) {
