...
public final class FutureKt {
    ...
    public static final <T> CompletableFuture<T> future(CoroutineScope coroutineScope, CoroutineContext coroutineContext, CoroutineStart coroutineStart, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        CompletableFuture<T> completableFutureM13017m = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m13017m();
        CompletableFutureCoroutine completableFutureCoroutine = new CompletableFutureCoroutine(coroutineContextNewCoroutineContext, completableFutureM13017m);
        completableFutureM13017m.handle(NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m13018m((Object) completableFutureCoroutine));
        completableFutureCoroutine.start(coroutineStart, completableFutureCoroutine, function2);
        return completableFutureM13017m;
    }

    public static final <T> CompletableFuture<T> asCompletableFuture(final Deferred<? extends T> deferred) {
        final CompletableFuture<T> completableFutureM13017m = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m13017m();
        setupCancellation(deferred, completableFutureM13017m);
        deferred.invokeOnCompletion(new Function1() { // from class: kotlinx.coroutines.future.FutureKt$$ExternalSyntheticLambda7
            ...
            public final Object invoke(Object obj) {
                return FutureKt.asCompletableFuture$lambda$1(completableFutureM13017m, deferred, (Throwable) obj);
            }
        });
        return completableFutureM13017m;
    }
    ...
    public static final CompletableFuture<Unit> asCompletableFuture(Job job) {
        final CompletableFuture<Unit> completableFutureM13017m = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m13017m();
        setupCancellation(job, completableFutureM13017m);
        job.invokeOnCompletion(new Function1() { // from class: kotlinx.coroutines.future.FutureKt$$ExternalSyntheticLambda10
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return FutureKt.asCompletableFuture$lambda$2(completableFutureM13017m, (Throwable) obj);
            }
        });
        return completableFutureM13017m;
    }
    ...
    public static final Object asDeferred$lambda$5(CompletableDeferred completableDeferred, Object obj, Throwable th) {
        ...
        try {
            if (th == null) {
                ...
                CompletionException completionExceptionM12598m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(th) ? PathTreeWalk$$ExternalSyntheticApiModelOutline0.m12598m((Object) th) : null;
                if (completionExceptionM12598m != null && (cause = completionExceptionM12598m.getCause()) != null) {
                    th = cause;
                }
    ...
    public static final <T> Object await(CompletionStage<T> completionStage, Continuation<? super T> continuation) throws Throwable {
        ...
        completionStage.handle(NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m13018m((Object) continuationHandler));
