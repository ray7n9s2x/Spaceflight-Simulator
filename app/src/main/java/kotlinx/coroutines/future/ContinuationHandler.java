...
final class ContinuationHandler<T> implements BiFunction<T, Throwable, Unit> {
    ...
    public void apply2(T result, Throwable exception) {
        ...
        if (exception == null) {
            ...
            continuation.resumeWith(Result.m11362constructorimpl(result));
            return;
        }
        CompletionException completionExceptionM12598m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(exception) ? PathTreeWalk$$ExternalSyntheticApiModelOutline0.m12598m((Object) exception) : null;
        if (completionExceptionM12598m != null && (cause = completionExceptionM12598m.getCause()) != null) {
            exception = cause;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m11362constructorimpl(ResultKt.createFailure(exception)));
    }
}
