...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo12976scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m12897delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m12898toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m12898toDelayMillisLRDsOJo(long j) {
        boolean zM12764isPositiveimpl = Duration.m12764isPositiveimpl(j);
        if (zM12764isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m12748getInWholeMillisecondsimpl(Duration.m12766plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM12764isPositiveimpl) {
