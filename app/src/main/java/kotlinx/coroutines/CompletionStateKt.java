...
public final class CompletionStateKt {
    public static final <T> Object toState(Object obj) {
        ...
        return thM11365exceptionOrNullimpl == null ? obj : new CompletedExceptionally(thM11365exceptionOrNullimpl, false, 2, null);
    }
        ...
        if (thM11365exceptionOrNullimpl != null) {
            if (DebugKt.getRECOVER_STACK_TRACES()) {
                ...
                if (cancellableContinuation2 instanceof CoroutineStackFrame) {
                    thM11365exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(thM11365exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation2);
                }
            }
            obj = new CompletedExceptionally(thM11365exceptionOrNullimpl, false, 2, null);
        }
        return obj;
    }
    ...
    public static final <T> Object recoverResult(Object obj, Continuation<? super T> continuation) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return Result.m11362constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame));
        }
