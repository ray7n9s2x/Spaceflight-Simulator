...
final /* synthetic */ class FlowKt__MergeKt {
    ...
    static final class C07421<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C07421(Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super C07421> continuation) {
            super(3, continuation);
            this.$transform = function2;
        }
        ...
        @Override // kotlin.jvm.functions.Function3
        public final Object invoke(FlowCollector<? super R> flowCollector, T t, Continuation<? super Unit> continuation) {
            C07421 c07421 = new C07421(this.$transform, continuation);
            c07421.L$0 = flowCollector;
            c07421.L$1 = t;
            return c07421.invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r6) {
            ...
            L48:
                ...
                return r6
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__MergeKt.C07421.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public static final <T, R> Flow<R> mapLatest(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        return FlowKt.transformLatest(flow, new C07421(function2, null));
    }
