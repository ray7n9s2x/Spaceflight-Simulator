...
public final class StateFlowKt {
    ...
    public static final <T> T updateAndGet(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        GameKillerApp gameKillerApp;
        T tInvoke;
        do {
            gameKillerApp = (Object) mutableStateFlow.getValue();
            tInvoke = function1.invoke(gameKillerApp);
        } while (!mutableStateFlow.compareAndSet(gameKillerApp, tInvoke));
        return tInvoke;
    }
    ...
    public static final <T> void update(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        do {
            gameKillerApp = (Object) mutableStateFlow.getValue();
        } while (!mutableStateFlow.compareAndSet(gameKillerApp, function1.invoke(gameKillerApp)));
    }
