...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM11362constructorimpl = Result.m11362constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM11362constructorimpl = Result.m11362constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m11368isFailureimpl(objM11362constructorimpl) ? null : objM11362constructorimpl);
