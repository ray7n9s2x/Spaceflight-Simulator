...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM12943trySendImplMj0NB7M = conflatedBufferedChannel.m12943trySendImplMj0NB7M(e, true);
        if (objM12943trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m12928exceptionOrNullimpl(objM12943trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM12943trySendImplMj0NB7M = conflatedBufferedChannel.m12943trySendImplMj0NB7M(e, true);
        if (!(objM12943trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo12909trySendJP2dKIU(E element) {
        return m12943trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m12943trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m12942trySendDropLatestMj0NB7M(element, isSendOp) : m12918trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m12942trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo12909trySendJP2dKIU = super.mo12909trySendJP2dKIU(element);
        if (ChannelResult.m12934isSuccessimpl(objMo12909trySendJP2dKIU) || ChannelResult.m12932isClosedimpl(objMo12909trySendJP2dKIU)) {
            return objMo12909trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo12909trySendJP2dKIU = mo12909trySendJP2dKIU(element);
        if (!(objMo12909trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo12909trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m12928exceptionOrNullimpl(objMo12909trySendJP2dKIU);
