...
public interface SendChannel<E> {
    ...
    Object mo12909trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m12934isSuccessimpl(objMo12909trySendJP2dKIU)) {
                return true;
            }
            Throwable thM12928exceptionOrNullimpl = ChannelResult.m12928exceptionOrNullimpl(objMo12909trySendJP2dKIU);
