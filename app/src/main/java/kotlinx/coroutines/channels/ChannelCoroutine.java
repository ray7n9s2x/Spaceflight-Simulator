...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo12916receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo12916receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo12917tryReceivePtdJZtk() {
        return this._channel.mo12917tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo12909trySendJP2dKIU(E e) {
        return this._channel.mo12909trySendJP2dKIU(e);
    }
