...
public final class ChannelResult<T> {
    ...
    public static final /* synthetic */ ChannelResult m12924boximpl(Object obj) {
        return new ChannelResult(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m12925constructorimpl(Object obj) {
        return obj;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m12926equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ChannelResult) && Intrinsics.areEqual(obj, ((ChannelResult) obj2).getHolder());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m12927equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m12931hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public boolean equals(Object other) {
        return m12926equalsimpl(this.holder, other);
    }

    public int hashCode() {
        return m12931hashCodeimpl(this.holder);
    }
    ...
    public static final boolean m12934isSuccessimpl(Object obj) {
        return !(obj instanceof Failed);
    }

    /* JADX INFO: renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m12933isFailureimpl(Object obj) {
        return obj instanceof Failed;
    }

    /* JADX INFO: renamed from: isClosed-impl, reason: not valid java name */
    public static final boolean m12932isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getOrNull-impl, reason: not valid java name */
    public static final T m12929getOrNullimpl(Object obj) {
    ...
    public static final T m12930getOrThrowimpl(Object obj) throws Throwable {
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static final Throwable m12928exceptionOrNullimpl(Object obj) {
    ...
    public static final class Companion {
        ...
        public final <E> Object m12939successJP2dKIU(E value) {
            return ChannelResult.m12925constructorimpl(value);
        }

        /* JADX INFO: renamed from: failure-PtdJZtk, reason: not valid java name */
        public final <E> Object m12938failurePtdJZtk() {
            return ChannelResult.m12925constructorimpl(ChannelResult.failed);
        }

        /* JADX INFO: renamed from: closed-JP2dKIU, reason: not valid java name */
        public final <E> Object m12937closedJP2dKIU(Throwable cause) {
            return ChannelResult.m12925constructorimpl(new Closed(cause));
        }
    }

    public String toString() {
        return m12935toStringimpl(this.holder);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m12935toStringimpl(Object obj) {
        if (obj instanceof Closed) {
