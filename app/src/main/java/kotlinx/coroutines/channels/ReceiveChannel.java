...
public interface ReceiveChannel<E> {
    ...
    Object mo12916receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo12917tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo12917tryReceivePtdJZtk = receiveChannel.mo12917tryReceivePtdJZtk();
            if (ChannelResult.m12934isSuccessimpl(objMo12917tryReceivePtdJZtk)) {
                return (E) ChannelResult.m12930getOrThrowimpl(objMo12917tryReceivePtdJZtk);
            }
            Throwable thM12928exceptionOrNullimpl = ChannelResult.m12928exceptionOrNullimpl(objMo12917tryReceivePtdJZtk);
            if (thM12928exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM12928exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) throws java.lang.Throwable {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo12916receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m12929getOrNullimpl(r4)
                return r4
            */
