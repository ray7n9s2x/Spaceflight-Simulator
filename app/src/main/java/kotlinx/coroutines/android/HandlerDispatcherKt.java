...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM11362constructorimpl = Result.m11362constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM11362constructorimpl = Result.m11362constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m11368isFailureimpl(objM11362constructorimpl) ? null : objM11362constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo12975dispatch(cancellableContinuationImpl2.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
