...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM11362constructorimpl = Result.m11362constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM11362constructorimpl = Result.m11362constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m11368isFailureimpl(objM11362constructorimpl)) {
                objM11362constructorimpl = null;
            }
            return (E) objM11362constructorimpl;
        }
    ...
    public static final Throwable safeCtor$lambda$9(Function1 function1, Throwable th) {
        ...
        try {
            ...
            objM11362constructorimpl = Result.m11362constructorimpl(th2);
        } catch (Throwable th3) {
            Result.Companion companion2 = Result.INSTANCE;
            objM11362constructorimpl = Result.m11362constructorimpl(ResultKt.createFailure(th3));
        }
        return (Throwable) (Result.m11368isFailureimpl(objM11362constructorimpl) ? null : objM11362constructorimpl);
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM11362constructorimpl = Result.m11362constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM11362constructorimpl = Result.m11362constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m11368isFailureimpl(objM11362constructorimpl)) {
            objM11362constructorimpl = numValueOf;
        }
        return ((Number) objM11362constructorimpl).intValue();
    }
