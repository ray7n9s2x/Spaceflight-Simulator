    ...
    */
    ...
    public final <R> List<R> map(Function1<? super E, ? extends R> transform) {
        ...
        while (true) {
            int i3 = this.mask;
            if ((i & i3) != (i3 & i2)) {
                GameKillerApp gameKillerApp = (Object) getArray().get(this.mask & i);
                if (gameKillerApp != null && !(gameKillerApp instanceof Placeholder)) {
                    arrayList.add(transform.invoke(gameKillerApp));
                }
                i++;
            } else {
                return arrayList;
