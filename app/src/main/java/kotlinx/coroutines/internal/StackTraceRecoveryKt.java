...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM11362constructorimpl2;
        ...
        try {
            ...
            objM11362constructorimpl = Result.m11362constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM11362constructorimpl = Result.m11362constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m11365exceptionOrNullimpl(objM11362constructorimpl) == null) {
            obj2 = objM11362constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM11362constructorimpl2 = Result.m11362constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM11362constructorimpl2 = Result.m11362constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m11365exceptionOrNullimpl(objM11362constructorimpl2) == null) {
            obj = objM11362constructorimpl2;
        }
