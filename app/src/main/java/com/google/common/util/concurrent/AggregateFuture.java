...
abstract class AggregateFuture<InputT, OutputT> extends AggregateFutureState<OutputT> {
    ...
    final void init() {
            ...
            while (it.hasNext()) {
                ...
                next.addListener(new Runnable() { // from class: com.google.common.util.concurrent.AggregateFuture$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m4228lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(next, i);
                    }
        ...
        Runnable runnable = new Runnable() { // from class: com.google.common.util.concurrent.AggregateFuture$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m4229lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(immutableCollection);
            }
        };
    ...
    /* synthetic */ void m4228lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(ListenableFuture listenableFuture, int i) {
        try {
            ...
            m4229lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(null);
        }
    }
    ...
    public void m4229lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(@CheckForNull ImmutableCollection<? extends Future<? extends InputT>> immutableCollection) {
