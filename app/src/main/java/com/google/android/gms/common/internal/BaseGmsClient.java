        ...
        synchronized (this.zzp) {
            ...
            if (i == 1) {
                ...
                if (this.zzF == null || Build.VERSION.SDK_INT < 33) {
                    ...
                    String str4 = strZza6;
                    connectionResultZza = gmsClientSupervisor4.zza(new zzn(strZza6, this.zza.zzb(), 4225, this.zza.zzc(), null), zzeVar3, zza(), getBindServiceExecutor());
                } else {
                    ...
                    connectionResultZza = gmsClientSupervisor5.zza(new zzn(strZza7, strZzb2, 4225, zZzc, userHandle), zzeVar3, strZza8, null);
                }
