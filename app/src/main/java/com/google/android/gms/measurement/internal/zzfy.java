...
public final class zzfy {
    ...
    static {
        ...
        Integer numValueOf = Integer.valueOf(CredentialOption.PRIORITY_DEFAULT);
        zzW = zza("measurement.upload.max_event_name_cardinality", numValueOf, numValueOf, null, false);
