...
public final class zzpk extends zzos {
    ...
    final zzoh zzf(String str, com.google.android.gms.internal.measurement.zzic zzicVar, com.google.android.gms.internal.measurement.zzhr zzhrVar, String str2) {
        ...
        Set setM11434m = UByte$$ExternalSyntheticBackport0.m11434m((Object[]) zzicVar2.zzc().zzk(str, zzfy.zzau).split(","));
        ...
        zzN(builder, "gmp_app_id", zzicVar.zzac(), setM11434m);
        zzicVar2.zzc().zzi();
        zzN(builder, "gmp_version", String.valueOf(133005L), setM11434m);
        ...
        zzN(builder, "app_instance_id", strZzV, setM11434m);
        zzN(builder, "rdid", zzicVar.zzP(), setM11434m);
        zzN(builder, "bundle_id", zzicVar.zzK(), setM11434m);
        String strZzk2 = zzhrVar.zzk();
        String strZza = zzjm.zza(strZzk2);
        if (true != TextUtils.isEmpty(strZza)) {
            strZzk2 = strZza;
        }
        zzN(builder, "app_event_name", strZzk2, setM11434m);
        zzN(builder, "app_version", String.valueOf(zzicVar.zzai()), setM11434m);
        ...
        zzN(builder, "os_version", strZzD, setM11434m);
        zzN(builder, "timestamp", String.valueOf(zzhrVar.zzn()), setM11434m);
        if (zzicVar.zzS()) {
            zzN(builder, "lat", "1", setM11434m);
        }
        zzN(builder, "privacy_sandbox_version", String.valueOf(zzicVar.zzaG()), setM11434m);
        zzN(builder, "trigger_uri_source", "1", setM11434m);
        zzN(builder, "trigger_uri_timestamp", String.valueOf(jCurrentTimeMillis), setM11434m);
        zzN(builder, "request_uuid", str2, setM11434m);
        ...
        zzQ(builder, zzicVar2.zzc().zzk(str, zzfy.zzat).split("\\|"), bundle, setM11434m);
        ...
        zzQ(builder, zzicVar2.zzc().zzk(str, zzfy.zzas).split("\\|"), bundle2, setM11434m);
        zzN(builder, "dma", true != zzicVar.zzaC() ? "0" : "1", setM11434m);
        if (!zzicVar.zzaE().isEmpty()) {
            zzN(builder, "dma_cps", zzicVar.zzaE(), setM11434m);
        }
        if (zzicVar.zzaK()) {
            com.google.android.gms.internal.measurement.zzha zzhaVarZzaL = zzicVar.zzaL();
            if (!zzhaVarZzaL.zzb().isEmpty()) {
                zzN(builder, "dl_gclid", zzhaVarZzaL.zzb(), setM11434m);
            }
            if (!zzhaVarZzaL.zzd().isEmpty()) {
                zzN(builder, "dl_gbraid", zzhaVarZzaL.zzd(), setM11434m);
            }
            if (!zzhaVarZzaL.zzf().isEmpty()) {
                zzN(builder, "dl_gs", zzhaVarZzaL.zzf(), setM11434m);
            }
            if (zzhaVarZzaL.zzh() > 0) {
                zzN(builder, "dl_ss_ts", String.valueOf(zzhaVarZzaL.zzh()), setM11434m);
            }
            if (!zzhaVarZzaL.zzj().isEmpty()) {
                zzN(builder, "mr_gclid", zzhaVarZzaL.zzj(), setM11434m);
            }
            if (!zzhaVarZzaL.zzm().isEmpty()) {
                zzN(builder, "mr_gbraid", zzhaVarZzaL.zzm(), setM11434m);
            }
            if (!zzhaVarZzaL.zzo().isEmpty()) {
                zzN(builder, "mr_gs", zzhaVarZzaL.zzo(), setM11434m);
            }
            if (zzhaVarZzaL.zzq() > 0) {
                zzN(builder, "mr_click_ts", String.valueOf(zzhaVarZzaL.zzq()), setM11434m);
            }
        }
