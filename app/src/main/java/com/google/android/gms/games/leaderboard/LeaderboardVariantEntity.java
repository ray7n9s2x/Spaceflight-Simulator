...
public final class LeaderboardVariantEntity implements LeaderboardVariant {
    ...
    static String zzf(LeaderboardVariant leaderboardVariant) {
        String str;
        Objects.ToStringHelper toStringHelperAdd = Objects.toStringHelper(leaderboardVariant).add("TimeSpan", zzz.zza(leaderboardVariant.getTimeSpan()));
        ...
        Objects.ToStringHelper toStringHelperAdd2 = toStringHelperAdd.add("Collection", str);
        boolean zHasPlayerInfo = leaderboardVariant.hasPlayerInfo();
        String displayPlayerRank = DevicePublicKeyStringDef.NONE;
        Objects.ToStringHelper toStringHelperAdd3 = toStringHelperAdd2.add("RawPlayerScore", zHasPlayerInfo ? Long.valueOf(leaderboardVariant.getRawPlayerScore()) : DevicePublicKeyStringDef.NONE).add("DisplayPlayerScore", leaderboardVariant.hasPlayerInfo() ? leaderboardVariant.getDisplayPlayerScore() : DevicePublicKeyStringDef.NONE).add("PlayerRank", leaderboardVariant.hasPlayerInfo() ? Long.valueOf(leaderboardVariant.getPlayerRank()) : DevicePublicKeyStringDef.NONE);
        if (leaderboardVariant.hasPlayerInfo()) {
            displayPlayerRank = leaderboardVariant.getDisplayPlayerRank();
        }
        return toStringHelperAdd3.add("DisplayPlayerRank", displayPlayerRank).add("NumScores", Long.valueOf(leaderboardVariant.getNumScores())).add("TopPageNextToken", leaderboardVariant.zza()).add("WindowPageNextToken", leaderboardVariant.zzc()).add("WindowPagePrevToken", leaderboardVariant.zzb()).toString();
    }
