...
public final class zzmb extends zzg {
    ...
    */
    ...
    public final void zzm(com.google.android.gms.internal.measurement.zzdf zzdfVar, Bundle bundle) {
        ...
        this.zzd.put(Integer.valueOf(zzdfVar.zza), new zzlu(bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.NAME), bundle2.getString("referrer_name"), bundle2.getLong(UnityNotificationManager.KEY_ID)));
    }
    ...
    public final void zzq(com.google.android.gms.internal.measurement.zzdf zzdfVar, Bundle bundle) {
        ...
        bundle2.putLong(UnityNotificationManager.KEY_ID, zzluVar.zzc);
