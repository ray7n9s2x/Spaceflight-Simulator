...
public final class zzbj extends zzav {
    ...
    public final zzao zza(String str, zzg zzgVar, List list) {
        ...
        if (iOrdinal != 3) {
            ...
            if (iOrdinal == 58) {
                ...
                if ((zzaoVarZza6 instanceof zzae) && (zzaoVarZza7 instanceof zzah)) {
                    ((zzae) zzaoVarZza6).zzn(zzaoVarZza7.zzd().intValue(), zzaoVarZza2);
                } else if (zzaoVarZza6 instanceof zzak) {
                    ((zzak) zzaoVarZza6).zzm(zzaoVarZza7.zzc(), zzaoVarZza2);
                    return zzaoVarZza2;
                }
            } else {
                if (iOrdinal == 17) {
                    ...
                    while (it.hasNext()) {
                        zzao zzaoVarZza8 = zzgVar.zza((zzao) it.next());
                        if (zzaoVarZza8 instanceof zzag) {
                            throw new IllegalStateException("Failed to evaluate array element");
                        }
                        zzaeVar.zzn(i, zzaoVarZza8);
                        i++;
                    }
                    return zzaeVar;
                }
                if (iOrdinal == 18) {
                    ...
                    while (i < list.size() - 1) {
                        zzao zzaoVarZza9 = zzgVar.zza((zzao) list.get(i));
                        zzao zzaoVarZza10 = zzgVar.zza((zzao) list.get(i + 1));
                        if ((zzaoVarZza9 instanceof zzag) || (zzaoVarZza10 instanceof zzag)) {
                            throw new IllegalStateException("Failed to evaluate map entry");
                        }
                        zzalVar.zzm(zzaoVarZza9.zzc(), zzaoVarZza10);
                        i += 2;
                    }
                    return zzalVar;
                }
                if (iOrdinal == 35 || iOrdinal == 36) {
                    ...
                    zzao zzaoVarZza12 = zzgVar.zza((zzao) list.get(1));
                    if ((zzaoVarZza11 instanceof zzae) && zzh.zzd(zzaoVarZza12)) {
                        return ((zzae) zzaoVarZza11).zzl(zzaoVarZza12.zzd().intValue());
                    }
                    if (zzaoVarZza11 instanceof zzak) {
                        return ((zzak) zzaoVarZza11).zzk(zzaoVarZza12.zzc());
                    }
                    if (zzaoVarZza11 instanceof zzas) {
                        if ("length".equals(zzaoVarZza12.zzc())) {
                            zzaoVarZza2 = new zzah(Double.valueOf(zzaoVarZza11.zzc().length()));
                        } else if (zzh.zzd(zzaoVarZza12) && zzaoVarZza12.zzd().doubleValue() < zzaoVarZza11.zzc().length()) {
                            zzaoVarZza = new zzas(String.valueOf(zzaoVarZza11.zzc().charAt(zzaoVarZza12.zzd().intValue())));
                        }
                    }
                    return zzao.zzf;
                }
                switch (iOrdinal) {
                    case 62:
                        ...
                        zzao zzaoVarZza13 = zzgVar.zza((zzao) list.get(0));
                        if (zzaoVarZza13 instanceof zzat) {
                            str2 = "undefined";
                        } else if (zzaoVarZza13 instanceof zzaf) {
                            str2 = "boolean";
                        } else if (zzaoVarZza13 instanceof zzah) {
                            str2 = "number";
                        } else if (zzaoVarZza13 instanceof zzas) {
                            str2 = "string";
                        } else if (zzaoVarZza13 instanceof zzan) {
                            str2 = "function";
                        } else {
                            if ((zzaoVarZza13 instanceof zzap) || (zzaoVarZza13 instanceof zzag)) {
                                throw new IllegalArgumentException(String.format("Unsupported value type %s in typeof", zzaoVarZza13));
                            }
                            str2 = "object";
                        }
                    ...
                    case 64:
                        ...
                        while (it2.hasNext()) {
                            zzao zzaoVarZza14 = zzgVar.zza((zzao) it2.next());
                            if (!(zzaoVarZza14 instanceof zzas)) {
                                throw new IllegalArgumentException(String.format("Expected string for var name. got %s", zzaoVarZza14.getClass().getCanonicalName()));
                            }
                            zzgVar.zzf(zzaoVarZza14.zzc(), zzao.zzf);
                        }
                        return zzao.zzf;
                    default:
        ...
        zzao zzaoVarZza15 = zzgVar.zza((zzao) list.get(0));
        if (!(zzaoVarZza15 instanceof zzas)) {
            throw new IllegalArgumentException(String.format("Expected string for assign var. got %s", zzaoVarZza15.getClass().getCanonicalName()));
        }
        if (!zzgVar.zzd(zzaoVarZza15.zzc())) {
            throw new IllegalArgumentException(String.format("Attempting to assign undefined value %s", zzaoVarZza15.zzc()));
        }
