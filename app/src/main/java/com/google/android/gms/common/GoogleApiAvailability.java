...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public Task<Void> makeGooglePlayServicesAvailable(Activity activity) {
        ...
        zabw zabwVarZaa = zabw.zaa(activity);
        zabwVarZaa.zaf(new ConnectionResult(iIsGooglePlayServicesAvailable, null), 0);
        return zabwVarZaa.zab();
    }
    ...
    final void zac(Context context, ConnectionResult connectionResult, String str) {
        ...
        if (zIsWearable) {
            ...
            style.setSmallIcon(android.R.drawable.stat_sys_warning).setTicker(resources.getString(com.google.android.gms.base.R.string.common_google_play_services_notification_ticker)).setWhen(System.currentTimeMillis()).setContentIntent(resolution).setContentText(strZad);
        }
        if (PlatformVersion.isAtLeastO()) {
            ...
            if (str2 == null) {
                ...
                if (notificationChannel == null) {
                    notificationManager.createNotificationChannel(SearchView$$ExternalSyntheticApiModelOutline0.m("com.google.android.gms.availability", string, 4));
