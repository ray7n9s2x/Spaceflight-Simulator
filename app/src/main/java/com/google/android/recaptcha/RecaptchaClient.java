...
public interface RecaptchaClient {
    ...
    Object mo4217execute0E7RQCE(RecaptchaAction recaptchaAction, long j, Continuation<? super Result<String>> continuation);

    /* JADX INFO: renamed from: execute-gIAlu-s, reason: not valid java name */
    Object mo4218executegIAlus(RecaptchaAction recaptchaAction, Continuation<? super Result<String>> continuation);
}
