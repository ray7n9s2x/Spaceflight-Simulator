...
public final class JavaDataStorage {
    ...
    static final class C02511<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        final /* synthetic */ T $defaultValue;
        final /* synthetic */ Preferences.Key<T> $key;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02511(Preferences.Key<T> key, T t, Continuation<? super C02511> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return JavaDataStorage.this.new C02511(this.$key, this.$defaultValue, continuation);
        }
    ...
    public final <T> T getSync(Preferences.Key<T> key, T defaultValue) {
        ...
        return (T) BuildersKt__BuildersKt.runBlocking$default(null, new C02511(key, defaultValue, null), 1, null);
    }
    ...
    static final class C02521 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Preferences>, Object> {
        final /* synthetic */ Preferences.Key<T> $key;
        final /* synthetic */ T $value;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02521(Preferences.Key<T> key, T t, Continuation<? super C02521> continuation) {
            super(2, continuation);
            this.$key = key;
            this.$value = t;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return JavaDataStorage.this.new C02521(this.$key, this.$value, continuation);
        }
        ...
        static final class C00621 extends SuspendLambda implements Function2<MutablePreferences, Continuation<? super Unit>, Object> {
            final /* synthetic */ Preferences.Key<T> $key;
            final /* synthetic */ T $value;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00621(Preferences.Key<T> key, T t, Continuation<? super C00621> continuation) {
                super(2, continuation);
                this.$key = key;
                this.$value = t;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00621 c00621 = new C00621(this.$key, this.$value, continuation);
                c00621.L$0 = obj;
                return c00621;
            }
            ...
            public final Object invoke(MutablePreferences mutablePreferences, Continuation<? super Unit> continuation) {
                return ((C00621) create(mutablePreferences, continuation)).invokeSuspend(Unit.INSTANCE);
            }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.label = 1;
                obj = PreferencesKt.edit(JavaDataStorage.this.dataStore, new C00621(this.$key, this.$value, null), this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
    ...
    public final <T> Preferences putSync(Preferences.Key<T> key, T value) {
        Intrinsics.checkNotNullParameter(key, "key");
        return (Preferences) BuildersKt__BuildersKt.runBlocking$default(null, new C02521(key, value, null), 1, null);
    }
    ...
    static final class C02501 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Map<Preferences.Key<?>, ? extends Object>>, Object> {
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return JavaDataStorage.this.new C02501(continuation);
        }
    ...
    public final Map<Preferences.Key<?>, Object> getAllSync() {
        return (Map) BuildersKt__BuildersKt.runBlocking$default(null, new C02501(null), 1, null);
    }
    ...
    static final class C02491 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Preferences>, Object> {
        final /* synthetic */ Function1<MutablePreferences, Unit> $transform;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C02491(Function1<? super MutablePreferences, Unit> function1, Continuation<? super C02491> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return JavaDataStorage.this.new C02491(this.$transform, continuation);
        }
            ...
            try {
                if (i == 0) {
                    ...
                    if (!Intrinsics.areEqual(JavaDataStorage.this.editLock.get(), Boxing.boxBoolean(true))) {
                        ...
                        this.label = 1;
                        obj = PreferencesKt.edit(JavaDataStorage.this.dataStore, new C00611(this.$transform, null), this);
                        if (obj == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
        ...
        static final class C00611 extends SuspendLambda implements Function2<MutablePreferences, Continuation<? super Unit>, Object> {
            final /* synthetic */ Function1<MutablePreferences, Unit> $transform;
            /* synthetic */ Object L$0;
            int label;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C00611(Function1<? super MutablePreferences, Unit> function1, Continuation<? super C00611> continuation) {
                super(2, continuation);
                this.$transform = function1;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00611 c00611 = new C00611(this.$transform, continuation);
                c00611.L$0 = obj;
                return c00611;
            }
            ...
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(MutablePreferences mutablePreferences, Continuation<? super Unit> continuation) {
                return ((C00611) create(mutablePreferences, continuation)).invokeSuspend(Unit.INSTANCE);
            }
    ...
    public final Preferences editSync(Function1<? super MutablePreferences, Unit> transform) {
        ...
        return (Preferences) BuildersKt__BuildersKt.runBlocking$default(null, new C02491(transform, null), 1, null);
    }
}
