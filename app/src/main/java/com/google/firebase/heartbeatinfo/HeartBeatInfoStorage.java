...
class HeartBeatInfoStorage {
    ...
    synchronized void deleteAllHeartBeats() {
        this.firebaseDataStore.editSync(new Function1() { // from class: com.google.firebase.heartbeatinfo.HeartBeatInfoStorage$$ExternalSyntheticLambda10
            ...
            public final Object invoke(Object obj) {
                return this.f$0.m4247xe97e9b5a((MutablePreferences) obj);
            }
        });
    }
    ...
    /* synthetic */ Unit m4247xe97e9b5a(MutablePreferences mutablePreferences) {
        long j = 0;
        for (Map.Entry<Preferences.Key<?>, Object> entry : mutablePreferences.asMap().entrySet()) {
            if (entry.getValue() instanceof Set) {
                ...
                if (set.contains(formattedDate)) {
                    mutablePreferences.set(key, UByte$$ExternalSyntheticBackport0.m11434m(new Object[]{formattedDate}));
                    j++;
                } else {
    ...
    synchronized void postHeartBeatCleanUp() {
        ...
        this.firebaseDataStore.editSync(new Function1() { // from class: com.google.firebase.heartbeatinfo.HeartBeatInfoStorage$$ExternalSyntheticLambda7
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return this.f$0.m4248x44e9f764(formattedDate, (MutablePreferences) obj);
            }
        });
    }
    ...
    /* synthetic */ Unit m4248x44e9f764(String str, MutablePreferences mutablePreferences) {
    ...
    synchronized void storeHeartBeat(long j, final String str) {
        ...
        this.firebaseDataStore.editSync(new Function1() { // from class: com.google.firebase.heartbeatinfo.HeartBeatInfoStorage$$ExternalSyntheticLambda9
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return this.f$0.m4249x76ccc570(formattedDate, str, keyStringSetKey, (MutablePreferences) obj);
            }
        });
    }
    ...
    /* synthetic */ Unit m4249x76ccc570(String str, String str2, Preferences.Key key, MutablePreferences mutablePreferences) {
