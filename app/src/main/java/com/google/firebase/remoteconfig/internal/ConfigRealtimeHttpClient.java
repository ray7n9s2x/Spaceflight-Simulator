...
public class ConfigRealtimeHttpClient {
    ...
    private void setCommonRequestHeaders(HttpURLConnection httpURLConnection, String str) {
        ...
        httpURLConnection.setRequestProperty(X_ACCEPT_RESPONSE_STREAMING, CredentialEntry.TRUE_STRING);
    ...
    */
    ...
    public Task<HttpURLConnection> createRealtimeConnection() {
        ...
        return Tasks.whenAllComplete((Task<?>[]) new Task[]{token, id}).continueWithTask(this.scheduledExecutorService, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigRealtimeHttpClient$$ExternalSyntheticLambda0
            ...
            public final Object then(Task task) {
                return this.f$0.m4286xad28ecdf(token, id, task);
            }
        });
    }
    ...
    /* synthetic */ Task m4286xad28ecdf(Task task, Task task2, Task task3) throws Exception {
        ...
        if (checkAndSetHttpConnectionFlagIfNotRunning()) {
            if (new Date(this.clock.currentTimeMillis()).before(this.sharedPrefsClient.getRealtimeBackoffMetadata().getBackoffEndTime())) {
                ...
                Tasks.whenAllComplete((Task<?>[]) new Task[]{taskCreateRealtimeConnection}).continueWith(this.scheduledExecutorService, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigRealtimeHttpClient$$ExternalSyntheticLambda1
                    @Override // com.google.android.gms.tasks.Continuation
                    public final Object then(Task task) {
                        return this.f$0.m4285x5fb1dc1(taskCreateRealtimeConnection, task);
                    }
                });
            }
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:49:0x00ca A[Catch: all -> 0x0135, TryCatch #2 {all -> 0x0135, blocks: (B:8:0x002b, B:10:0x0030, B:47:0x00c6, B:49:0x00ca, B:50:0x00ce), top: B:89:0x0009 }] */
    /* JADX WARN: Removed duplicated region for block: B:50:0x00ce A[Catch: all -> 0x0135, TRY_LEAVE, TryCatch #2 {all -> 0x0135, blocks: (B:8:0x002b, B:10:0x0030, B:47:0x00c6, B:49:0x00ca, B:50:0x00ce), top: B:89:0x0009 }] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    /* synthetic */ com.google.android.gms.tasks.Task m4285x5fb1dc1(com.google.android.gms.tasks.Task r11, com.google.android.gms.tasks.Task r12) throws java.lang.Exception {
        /*
            Method dump skipped, instruction units count: 402
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.remoteconfig.internal.ConfigRealtimeHttpClient.m4285x5fb1dc1(com.google.android.gms.tasks.Task, com.google.android.gms.tasks.Task):com.google.android.gms.tasks.Task");
    }
