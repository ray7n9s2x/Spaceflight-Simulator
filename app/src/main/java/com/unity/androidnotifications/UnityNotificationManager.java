...
import com.teamcuriosity.addons.SafUtil$$ExternalSyntheticApiModelOutline0;
...
public class UnityNotificationManager extends BroadcastReceiver {
    ...
    public void registerNotificationChannelGroup(String str, String str2, String str3) {
        if (Build.VERSION.SDK_INT >= 26) {
            NotificationChannelGroup notificationChannelGroupM = SafUtil$$ExternalSyntheticApiModelOutline0.m(str, str2);
    ...
    public void registerNotificationChannel(String str, String str2, int i, String str3, boolean z, boolean z2, boolean z3, boolean z4, long[] jArr, int i2, String str4) {
        if (Build.VERSION.SDK_INT >= 26) {
            NotificationChannel notificationChannelM = SafUtil$$ExternalSyntheticApiModelOutline0.m(str, str2, i);
    ...
    private static NotificationChannelWrapper notificationChannelToWrapper(Object obj) {
        NotificationChannel notificationChannelM = SafUtil$$ExternalSyntheticApiModelOutline0.m(obj);
        NotificationChannelWrapper notificationChannelWrapper = new NotificationChannelWrapper();
        notificationChannelWrapper.id = notificationChannelM.getId();
        notificationChannelWrapper.name = notificationChannelM.getName().toString();
        notificationChannelWrapper.importance = notificationChannelM.getImportance();
        notificationChannelWrapper.description = notificationChannelM.getDescription();
        notificationChannelWrapper.enableLights = notificationChannelM.shouldShowLights();
        notificationChannelWrapper.enableVibration = notificationChannelM.shouldVibrate();
        notificationChannelWrapper.canBypassDnd = notificationChannelM.canBypassDnd();
        notificationChannelWrapper.canShowBadge = notificationChannelM.canShowBadge();
        notificationChannelWrapper.vibrationPattern = notificationChannelM.getVibrationPattern();
        notificationChannelWrapper.lockscreenVisibility = notificationChannelM.getLockscreenVisibility();
        notificationChannelWrapper.group = notificationChannelM.getGroup();
        return notificationChannelWrapper;
    }
    ...
    public NotificationChannelWrapper[] getNotificationChannels() {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                notificationChannelWrapperArr[i] = notificationChannelToWrapper(SafUtil$$ExternalSyntheticApiModelOutline0.m(it.next()));
                i++;
            }
    ...
    public int scheduleNotification(Notification.Builder builder, boolean z) {
        ...
        if (extras.containsKey(KEY_ID)) {
            ...
            extras.putInt(KEY_ID, iGenerateUniqueId);
            i = iGenerateUniqueId;
        }
    ...
    private PendingIntent getActivityPendingIntent(int i, Intent intent, int i2) {
        return PendingIntent.getActivity(this.mContext, i, intent, i2 | AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL);
    }

    private PendingIntent getBroadcastPendingIntent(int i, Intent intent, int i2) {
        return PendingIntent.getBroadcast(this.mContext, i, intent, i2 | AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL);
    }
    ...
    /* synthetic */ void m6625x329bd7ea(Integer num) throws IOException {
    ...
    public Notification.Builder createNotificationBuilder(String str) {
        ...
        SafUtil$$ExternalSyntheticApiModelOutline0.m();
        return SafUtil$$ExternalSyntheticApiModelOutline0.m(this.mContext, str);
    }
    ...
    private Notification.Builder deserializeNotificationBuilder(Integer num) throws IOException {
