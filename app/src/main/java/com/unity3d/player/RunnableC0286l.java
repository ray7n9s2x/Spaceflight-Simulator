...
final class RunnableC0286l implements Runnable {
    ...
    RunnableC0286l(IAssetPackManagerStatusQueryCallback iAssetPackManagerStatusQueryCallback, long j, String[] strArr, int[] iArr, int[] iArr2) {
