...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(Person.fromAndroidPerson(SearchView$$ExternalSyntheticApiModelOutline0.m6m(it2.next())));
                }
            }
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                while (it.hasNext()) {
                    Api24Impl.addMessage(SearchView$$ExternalSyntheticApiModelOutline0.m((Object) messagingStyleCreateMessagingStyle), it.next().toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    Iterator<Message> it2 = this.mHistoricMessages.iterator();
                    while (it2.hasNext()) {
                        Api26Impl.addHistoricMessage(SearchView$$ExternalSyntheticApiModelOutline0.m((Object) messagingStyleCreateMessagingStyle), it2.next().toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(SearchView$$ExternalSyntheticApiModelOutline0.m((Object) messagingStyleCreateMessagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(SearchView$$ExternalSyntheticApiModelOutline0.m((Object) messagingStyleCreateMessagingStyle), this.mIsGroupConversation.booleanValue());
                }
                ...
                try {
                    if (bundle.containsKey(KEY_TEXT) && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            personBuild = Person.fromAndroidPerson(SearchView$$ExternalSyntheticApiModelOutline0.m6m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else {
    ...
    public static class CallStyle extends Style {
        ...
        protected void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(SearchView$$ExternalSyntheticApiModelOutline0.m6m((Object) bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        public static List<CharSequence> getTextsFromContentView(Context context, Notification notification) {
            ...
            if (!SearchView$$ExternalSyntheticApiModelOutline0.m$1().getName().equals(notification.extras.getString(NotificationCompat.EXTRA_TEMPLATE))) {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m60clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m61clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(SearchView$$ExternalSyntheticApiModelOutline0.m6m(it.next())));
                }
            }
        } else {
