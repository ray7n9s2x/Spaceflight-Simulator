...
public class ShortcutManagerCompat {
    ...
    public static boolean isRequestPinShortcutSupported(Context context) {
        if (Build.VERSION.SDK_INT >= 26) {
            return SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).isRequestPinShortcutSupported();
        }
    ...
    public static boolean requestPinShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat, final IntentSender intentSender) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).requestPinShortcut(shortcutInfoCompat.toShortcutInfo(), intentSender);
        }
    ...
    public static Intent createShortcutResultIntent(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        Intent intentCreateShortcutResultIntent = Build.VERSION.SDK_INT >= 26 ? SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).createShortcutResultIntent(shortcutInfoCompat.toShortcutInfo()) : null;
    ...
    public static List<ShortcutInfoCompat> getShortcuts(Context context, int i) {
        if (Build.VERSION.SDK_INT >= 30) {
            return ShortcutInfoCompat.fromShortcuts(context, SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).getShortcuts(i));
        }
        if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManager shortcutManagerM10m = SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3()));
            ArrayList arrayList = new ArrayList();
            if ((i & 1) != 0) {
                arrayList.addAll(shortcutManagerM10m.getManifestShortcuts());
            }
            if ((i & 2) != 0) {
                arrayList.addAll(shortcutManagerM10m.getDynamicShortcuts());
            }
            if ((i & 4) != 0) {
                arrayList.addAll(shortcutManagerM10m.getPinnedShortcuts());
            }
    ...
    public static boolean addDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).addDynamicShortcuts(arrayList)) {
                return false;
            }
        }
    ...
    public static int getMaxShortcutCountPerActivity(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            return SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).getMaxShortcutCountPerActivity();
        }
        return 5;
    }
    ...
    public static boolean isRateLimitingActive(Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).isRateLimitingActive();
        }
    ...
    public static int getIconMaxWidth(Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).getIconMaxWidth();
        }
    ...
    public static int getIconMaxHeight(Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).getIconMaxHeight();
        }
    ...
    public static void reportShortcutUsed(Context context, String str) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).reportShortcutUsed(str);
        }
    ...
    public static boolean setDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).setDynamicShortcuts(arrayList)) {
                return false;
            }
        }
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            List dynamicShortcuts = SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).getDynamicShortcuts();
            ArrayList arrayList = new ArrayList(dynamicShortcuts.size());
            Iterator it = dynamicShortcuts.iterator();
            while (it.hasNext()) {
                arrayList.add(new ShortcutInfoCompat.Builder(context, SearchView$$ExternalSyntheticApiModelOutline0.m9m(it.next())).build());
            }
            return arrayList;
        }
        try {
    ...
    public static boolean updateShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).updateShortcuts(arrayList)) {
                return false;
            }
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
    ...
    public static void disableShortcuts(Context context, List<String> list, CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 25) {
            SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).disableShortcuts(list, charSequence);
        }
    ...
    public static void enableShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).enableShortcuts(arrayList);
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
        Iterator<ShortcutInfoChangeListener> it2 = getShortcutInfoListeners(context).iterator();
        while (it2.hasNext()) {
    ...
    public static void removeDynamicShortcuts(Context context, List<String> list) {
        if (Build.VERSION.SDK_INT >= 25) {
            SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).removeDynamicShortcuts(list);
        }
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static void removeAllDynamicShortcuts(Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).removeAllDynamicShortcuts();
        }
        getShortcutInfoSaverInstance(context).removeAllShortcuts();
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static void removeLongLivedShortcuts(Context context, List<String> list) {
        ...
        SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).removeLongLivedShortcuts(list);
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
            it.next().onShortcutRemoved(list);
    ...
    public static boolean pushDynamicShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3())).pushDynamicShortcut(shortcutInfoCompat.toShortcutInfo());
        } else if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManager shortcutManagerM10m = SearchView$$ExternalSyntheticApiModelOutline0.m10m(context.getSystemService(SearchView$$ExternalSyntheticApiModelOutline0.m$3()));
            if (shortcutManagerM10m.isRateLimitingActive()) {
                return false;
            }
            List dynamicShortcuts = shortcutManagerM10m.getDynamicShortcuts();
            if (dynamicShortcuts.size() >= maxShortcutCountPerActivity) {
                shortcutManagerM10m.removeDynamicShortcuts(Arrays.asList(Api25Impl.getShortcutInfoWithLowestRank(dynamicShortcuts)));
            }
            shortcutManagerM10m.addDynamicShortcuts(Arrays.asList(shortcutInfoCompat.toShortcutInfo()));
        }
