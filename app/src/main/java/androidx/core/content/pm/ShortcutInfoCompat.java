...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        SearchView$$ExternalSyntheticApiModelOutline0.m20m();
        ShortcutInfo.Builder intents = SearchView$$ExternalSyntheticApiModelOutline0.m(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, SearchView$$ExternalSyntheticApiModelOutline0.m9m((Object) it.next())).build());
        }
        return arrayList;
    }
