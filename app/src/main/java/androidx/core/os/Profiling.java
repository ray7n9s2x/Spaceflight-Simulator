...
public final class Profiling {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<ProducerScope<? super ProfilingResult>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                final ProfilingManager profilingManagerM95m = HalfKt$$ExternalSyntheticApiModelOutline0.m95m(this.$context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m113m$1()));
                profilingManagerM95m.registerForAllProfilingResults(new Executor() { // from class: androidx.core.os.Profiling$registerForAllProfilingResults$1$$ExternalSyntheticLambda1
                ...
                if (ProduceKt.awaitClose(producerScope, new Function0<Unit>() { // from class: androidx.core.os.Profiling.registerForAllProfilingResults.1.2
                    ...
                    public final void invoke2() {
                        profilingManagerM95m.unregisterForAllProfilingResults(consumer);
                    }
        ...
        public static final void invokeSuspend$lambda$0(ProducerScope producerScope, ProfilingResult result) {
            ...
            producerScope.mo12909trySendJP2dKIU(result);
        }
    }
    ...
    public static final void registerForAllProfilingResults(Context context, Executor executor, Consumer<ProfilingResult> listener) {
        ...
        HalfKt$$ExternalSyntheticApiModelOutline0.m95m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m113m$1())).registerForAllProfilingResults(executor, listener);
    }

    public static final void unregisterForAllProfilingResults(Context context, Consumer<ProfilingResult> listener) {
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(listener, "listener");
        HalfKt$$ExternalSyntheticApiModelOutline0.m95m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m113m$1())).unregisterForAllProfilingResults(listener);
    }
    ...
    public static final void requestProfiling(Context context, ProfilingRequest profilingRequest, Executor executor, Consumer<ProfilingResult> consumer) {
        ...
        HalfKt$$ExternalSyntheticApiModelOutline0.m95m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m113m$1())).requestProfiling(profilingRequest.getProfilingType(), profilingRequest.getParams(), profilingRequest.getTag(), profilingRequest.getCancellationSignal(), executor, consumer);
    }
}
