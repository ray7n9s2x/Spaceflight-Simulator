    ...
    private static final class Ext10Impl {
        ...
        public static final class Companion {
            ...
            public final android.adservices.common.AdData convertAdData(AdData adData) {
                ...
                AdData.Builder adCounterKeys = AdFilters$$ExternalSyntheticApiModelOutline0.m441m().setMetadata(adData.getMetadata()).setRenderUri(adData.getRenderUri()).setAdCounterKeys(adData.getAdCounterKeys());
    ...
    private static final class Ext4Impl {
        ...
        public static final class Companion {
            ...
            public final android.adservices.common.AdData convertAdData(AdData adData) {
                ...
                android.adservices.common.AdData adDataBuild = AdFilters$$ExternalSyntheticApiModelOutline0.m441m().setMetadata(adData.getMetadata()).setRenderUri(adData.getRenderUri()).build();
                Intrinsics.checkNotNullExpressionValue(adDataBuild, "Builder()\n              …                 .build()");
                return adDataBuild;
            }
        }
