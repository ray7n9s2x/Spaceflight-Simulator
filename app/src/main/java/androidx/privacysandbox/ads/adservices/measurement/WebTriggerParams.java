    ...
    public static final class Companion {
        ...
        public final List<android.adservices.measurement.WebTriggerParams> convertWebTriggerParams$ads_adservices_release(List<WebTriggerParams> request) {
            ...
            for (WebTriggerParams webTriggerParams : request) {
                ...
                android.adservices.measurement.WebTriggerParams webTriggerParamsBuild = a$$ExternalSyntheticApiModelOutline0.m483m(webTriggerParams.getRegistrationUri()).setDebugKeyAllowed(webTriggerParams.getDebugKeyAllowed()).build();
