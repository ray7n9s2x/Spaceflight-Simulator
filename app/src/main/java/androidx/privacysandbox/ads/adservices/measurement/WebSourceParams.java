    ...
    public static final class Companion {
        ...
        public final List<android.adservices.measurement.WebSourceParams> convertWebSourceParams$ads_adservices_release(List<WebSourceParams> request) {
            ...
            for (WebSourceParams webSourceParams : request) {
                a$$ExternalSyntheticApiModelOutline0.m501m();
                android.adservices.measurement.WebSourceParams webSourceParamsBuild = a$$ExternalSyntheticApiModelOutline0.m(webSourceParams.getRegistrationUri()).setDebugKeyAllowed(webSourceParams.getDebugKeyAllowed()).build();
