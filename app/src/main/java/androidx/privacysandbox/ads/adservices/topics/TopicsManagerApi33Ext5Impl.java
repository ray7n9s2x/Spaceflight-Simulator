...
public final class TopicsManagerApi33Ext5Impl extends TopicsManagerImplCommon {
    ...
    public TopicsManagerApi33Ext5Impl(Context context) {
        ...
        Object systemService = context.getSystemService((Class<Object>) a$$ExternalSyntheticApiModelOutline0.m$1());
        Intrinsics.checkNotNullExpressionValue(systemService, "context.getSystemService…opicsManager::class.java)");
        super(a$$ExternalSyntheticApiModelOutline0.m492m(systemService));
    }
