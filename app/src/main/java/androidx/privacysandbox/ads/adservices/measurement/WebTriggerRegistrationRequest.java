...
public final class WebTriggerRegistrationRequest {
    ...
    public final android.adservices.measurement.WebTriggerRegistrationRequest convertToAdServices$ads_adservices_release() {
        a$$ExternalSyntheticApiModelOutline0.m$3();
        android.adservices.measurement.WebTriggerRegistrationRequest webTriggerRegistrationRequestBuild = a$$ExternalSyntheticApiModelOutline0.m484m((List) WebTriggerParams.INSTANCE.convertWebTriggerParams$ads_adservices_release(this.webTriggerParams), this.destination).build();
