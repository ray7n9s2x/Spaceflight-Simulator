...
public final class SharedPreferencesMigrationKt {
    ...
    static final class C02431 extends SuspendLambda implements Function2<Preferences, Continuation<? super Boolean>, Object> {
        final /* synthetic */ Set<String> $keysToMigrate;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02431(Set<String> set, Continuation<? super C02431> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02431 c02431 = new C02431(this.$keysToMigrate, continuation);
            c02431.L$0 = obj;
            return c02431;
        }
        ...
        public final Object invoke(Preferences preferences, Continuation<? super Boolean> continuation) {
            return ((C02431) create(preferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }
