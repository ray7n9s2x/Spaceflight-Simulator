...
public final class StorageConnectionKt {
    ...
    static final class C02402<T> extends SuspendLambda implements Function2<WriteScope<T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ T $value;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02402(T t, Continuation<? super C02402> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02402 c02402 = new C02402(this.$value, continuation);
            c02402.L$0 = obj;
            return c02402;
        }
        ...
        public final Object invoke(WriteScope<T> writeScope, Continuation<? super Unit> continuation) {
            return ((C02402) create(writeScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object writeData(StorageConnection<T> storageConnection, T t, Continuation<? super Unit> continuation) {
        Object objWriteScope = storageConnection.writeScope(new C02402(t, null), continuation);
