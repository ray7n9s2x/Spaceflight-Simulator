...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object objM12929getOrNullimpl = ChannelResult.m12929getOrNullimpl(((SimpleActor) this).messageQueue.mo12917tryReceivePtdJZtk());
                        if (objM12929getOrNullimpl != null) {
                            onUndeliveredElement.invoke((T) objM12929getOrNullimpl, th);
                            unit = Unit.INSTANCE;
                        } else {
                            unit = null;
                        }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo12909trySendJP2dKIU(msg);
        if (obj instanceof ChannelResult.Closed) {
            Throwable thM12928exceptionOrNullimpl = ChannelResult.m12928exceptionOrNullimpl(obj);
            if (thM12928exceptionOrNullimpl != null) {
                throw thM12928exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m12934isSuccessimpl(obj)) {
