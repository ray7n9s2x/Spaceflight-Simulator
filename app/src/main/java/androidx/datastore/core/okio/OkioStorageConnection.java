...
public final class OkioStorageConnection<T> implements StorageConnection<T> {
    ...
    static final class C02411 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02411(OkioStorageConnection<T> okioStorageConnection, Continuation<? super C02411> continuation) {
            super(continuation);
            this.this$0 = okioStorageConnection;
        }
    ...
    */
    public <R> java.lang.Object readScope(kotlin.jvm.functions.Function3<? super androidx.datastore.core.ReadScope<T>, ? super java.lang.Boolean, ? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object> r10, kotlin.coroutines.Continuation<? super R> r11) throws java.lang.Throwable {
        /*
            r9 = this;
            boolean r0 = r11 instanceof androidx.datastore.core.okio.OkioStorageConnection.AnonymousClass1
            if (r0 == 0) goto L14
            r0 = r11
