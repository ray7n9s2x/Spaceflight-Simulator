...
public final class DataStoreImpl<T> implements DataStore<T> {
    ...
    static final class C02271 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02271(DataStoreImpl<T> dataStoreImpl, Continuation<? super C02271> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    static final class C02281 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02281(DataStoreImpl<T> dataStoreImpl, Continuation<? super C02281> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    static final class C02291 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02291(DataStoreImpl<T> dataStoreImpl, Continuation<? super C02291> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    static final class C02301 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02301(DataStoreImpl<T> dataStoreImpl, Continuation<? super C02301> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "androidx.datastore.core.DataStoreImpl", f = "DataStoreImpl.kt", i = {0, 0, 1, 1, 2, 2, 3, 3, 4, 4, 4, 4, 5, 5, 5}, l = {365, 366, 368, 369, 380, AndroidBinXmlParser.Chunk.RES_XML_TYPE_RESOURCE_MAP}, m = "readDataOrHandleCorruption", n = {"this", "hasWriteFileLock", "this", "hasWriteFileLock", "this", "hasWriteFileLock", "this", "hasWriteFileLock", "this", "ex", "newData", "hasWriteFileLock", "ex", "newData", "version"}, s = {"L$0", "Z$0", "L$0", "Z$0", "L$0", "Z$0", "L$0", "Z$0", "L$0", "L$1", "L$2", "Z$0", "L$0", "L$1", "L$2"})
    static final class C02321 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02321(DataStoreImpl<T> dataStoreImpl, Continuation<? super C02321> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    */
    public final java.lang.Object incrementCollector(kotlin.coroutines.Continuation<? super kotlin.Unit> r12) throws java.lang.Throwable {
        /*
            r11 = this;
            boolean r0 = r12 instanceof androidx.datastore.core.DataStoreImpl.C02281
            if (r0 == 0) goto L14
            r0 = r12
            androidx.datastore.core.DataStoreImpl$incrementCollector$1 r0 = (androidx.datastore.core.DataStoreImpl.C02281) r0
            int r1 = r0.label
    ...
    */
    ...
    public Object updateData(Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        ...
        return BuildersKt.withContext(new UpdatingDataContextElement(updatingDataContextElement, this), new C02362(this, function2, null), continuation);
    }
    ...
    static final class C02362 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C02362(DataStoreImpl<T> dataStoreImpl, Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C02362> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02362 c02362 = new C02362(this.this$0, this.$transform, continuation);
            c02362.L$0 = obj;
            return c02362;
        }
    ...
    static final class C02342 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super State<T>>, Object> {
        final /* synthetic */ boolean $requireLock;
        int label;
        final /* synthetic */ DataStoreImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02342(DataStoreImpl<T> dataStoreImpl, boolean z, Continuation<? super C02342> continuation) {
            super(2, continuation);
            this.this$0 = dataStoreImpl;
            this.$requireLock = z;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02342(this.this$0, this.$requireLock, continuation);
        }
    ...
    public final Object readState(boolean z, Continuation<? super State<T>> continuation) {
        return BuildersKt.withContext(this.scope.getCoroutineContext(), new C02342(this, z, null), continuation);
    }
    ...
    */
    public final java.lang.Object readAndInitOrPropagateAndThrowFailure(kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            r5 = this;
            boolean r0 = r6 instanceof androidx.datastore.core.DataStoreImpl.C02291
            if (r0 == 0) goto L14
            r0 = r6
            androidx.datastore.core.DataStoreImpl$readAndInitOrPropagateAndThrowFailure$1 r0 = (androidx.datastore.core.DataStoreImpl.C02291) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    */
    ...
    static final class C02313 extends SuspendLambda implements Function1<Continuation<? super Pair<? extends State<T>, ? extends Boolean>>, Object> {
        Object L$0;
        int label;
        final /* synthetic */ DataStoreImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02313(DataStoreImpl<T> dataStoreImpl, Continuation<? super C02313> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C02313(this.this$0, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Pair<? extends State<T>, Boolean>> continuation) {
            return ((C02313) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static final class C02352 extends SuspendLambda implements Function1<Continuation<? super T>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C02352(DataStoreImpl<T> dataStoreImpl, CoroutineContext coroutineContext, Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C02352> continuation) {
            super(1, continuation);
            this.this$0 = dataStoreImpl;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C02352(this.this$0, this.$callerContext, this.$transform, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super T> continuation) {
            return ((C02352) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r9) throws java.lang.Throwable {
            ...
            L78:
                return r9
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.core.DataStoreImpl.C02352.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public final Object transformAndWrite(Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, CoroutineContext coroutineContext, Continuation<? super T> continuation) {
        return getCoordinator().lock(new C02352(this, coroutineContext, function2, null), continuation);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.Object writeData$datastore_core_release(T r12, boolean r13, kotlin.coroutines.Continuation<? super java.lang.Integer> r14) throws java.lang.Throwable {
        /*
            r11 = this;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.Object readDataOrHandleCorruption(boolean r11, kotlin.coroutines.Continuation<? super androidx.datastore.core.Data<T>> r12) throws java.lang.Throwable {
        /*
    ...
    static final class C02333 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02333(Ref.ObjectRef<T> objectRef, DataStoreImpl<T> dataStoreImpl, Ref.IntRef intRef, Continuation<? super C02333> continuation) {
            super(1, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C02333(this.$newData, this.this$0, this.$version, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C02333) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
