...
public final class FloatFloatPair {
    ...
    public static final /* synthetic */ FloatFloatPair m33boximpl(long j) {
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m36constructorimpl(float f, float f2) {
        return m37constructorimpl((((long) Float.floatToRawIntBits(f2)) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }

    /* JADX INFO: renamed from: getFirst-impl, reason: not valid java name */
    public static final float m40getFirstimpl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* JADX INFO: renamed from: getSecond-impl, reason: not valid java name */
    public static final float m41getSecondimpl(long j) {
        return Float.intBitsToFloat((int) (j & 4294967295L));
    }

    /* JADX INFO: renamed from: component1-impl, reason: not valid java name */
    public static final float m34component1impl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* JADX INFO: renamed from: component2-impl, reason: not valid java name */
    public static final float m35component2impl(long j) {
        return Float.intBitsToFloat((int) (j & 4294967295L));
    }
}
