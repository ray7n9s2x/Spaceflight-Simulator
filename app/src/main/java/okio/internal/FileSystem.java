...
public final class FileSystem {
    ...
    static final class C07621 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        ...
        C07621(Path path, okio.FileSystem fileSystem, boolean z, Continuation<? super C07621> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C07621 c07621 = new C07621(this.$dir, this.$this_commonListRecursively, this.$followSymlinks, continuation);
            c07621.L$0 = obj;
            return c07621;
        }
        ...
        public final Object invoke(SequenceScope<? super Path> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C07621) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Sequence<Path> commonListRecursively(okio.FileSystem fileSystem, Path dir, boolean z) throws IOException {
        Intrinsics.checkNotNullParameter(fileSystem, "<this>");
        Intrinsics.checkNotNullParameter(dir, "dir");
        return SequencesKt.sequence(new C07621(dir, fileSystem, z, null));
    }
